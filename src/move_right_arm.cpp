...
std::vector<double> pasta1 = {-117.471276 * M_PI / 180, 38.069285 * M_PI / 180,
                              0.998478 * M_PI / 180, 52.067126 * M_PI / 180,
                              43.106447 * M_PI / 180, -37.614258 * M_PI / 180};

std::vector<double> pasta2 = {-90.818491 * M_PI / 180, 26.352905 * M_PI / 180,
                              -29.571683 * M_PI / 180, 10.209492 * M_PI / 180,
                              57.126326 * M_PI / 180, -5.747538 * M_PI / 180};

std::vector<double> pasta3 = {-58.354794 * M_PI / 180, 39.417151 * M_PI / 180,
                              -9.946009 * M_PI / 180, -39.666651 * M_PI / 180,
                              60.971132 * M_PI / 180, 26.101631 * M_PI / 180};

std::vector<double> boiler = {-38.106971 * M_PI / 180, 9.952785 * M_PI / 180,
...
int main(int argc, char **argv)
{
    ...
    //pasta cooker
    arm_joint_values = boiler;
    arm.moveTargetJoint(arm_joint_values, true, true);

    //pasta 1
    arm_joint_values = pasta1;
    arm.moveTargetJoint(arm_joint_values, true, true);

    //pasta 2
    arm_joint_values = pasta2;
    arm.moveTargetJoint(arm_joint_values, true, true);

    //pasta 3
    arm_joint_values = pasta3;
    arm.moveTargetJoint(arm_joint_values, true, true);
